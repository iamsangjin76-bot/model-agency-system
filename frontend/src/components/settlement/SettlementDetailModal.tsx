      ...
      <div className="bg-white rounded-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          ...
          {settlement.description && (
            <div className="p-3 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-700">{settlement.description}</p>
            </div>
          )}
        </div>
        ...
        <div className="p-6 border-t border-gray-200 flex justify-between bg-gray-50">
          ...
          <div className="flex gap-3">
            <button onClick={onEdit} className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">
              수정
            </button>
            {isPending && (
              <button
