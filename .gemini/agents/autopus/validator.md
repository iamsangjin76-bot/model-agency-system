...
- Codex: keep `gpt-5.4`; raise reasoning effort for Layer 2 / Check 7
- OpenCode: keep the platform default `gpt-5.4`; treat Layer 2 / Check 7 as higher-reasoning validation passes
