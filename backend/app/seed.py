...
def seed_models(db, admin_ids: dict) -> dict:
    ...
    records = [
        dict(name="김민지", model_type=ModelType.NEW_MODEL, gender=Gender.FEMALE,
             height=172, weight=50.0, birth_date=date(2001, 3, 15),
             hobby="요가, 수영", keywords="#청순한 #긴머리 #신인",
             instagram_id="minji_model", instagram_followers=12500,
             contact1="010-1111-2222"),
        dict(name="이현", model_type=ModelType.INFLUENCER, gender=Gender.MALE,
             height=182, weight=70.0, birth_date=date(1995, 7, 22),
             hobby="피트니스, 사진촬영", keywords="#남성모델 #피트니스 #인플루언서",
             instagram_id="hyun_official", instagram_followers=450000,
             youtube_id="hyun_vlog", youtube_subscribers=85000,
             tiktok_id="hyun_tok", tiktok_followers=120000,
             contact1="010-3333-4444"),
        dict(name="Sarah Johnson", model_type=ModelType.FOREIGN_MODEL, gender=Gender.FEMALE,
             height=175, nationality="미국", birth_date=date(1998, 11, 5),
             hobby="painting, dancing", keywords="#외국인 #글로벌 #패션",
             instagram_id="sarahjohnson", instagram_followers=89000,
             languages="English, Korean (basic)",
             contact1="010-5555-6666"),
        dict(name="박서준", model_type=ModelType.CELEBRITY, gender=Gender.MALE,
             height=180, weight=68.0, birth_date=date(1988, 12, 16),
             hobby="연기, 골프", keywords="#연예인 #배우 #톱스타",
             instagram_id="bn_sj2013", instagram_followers=19800000,
             youtube_id="record_psj", youtube_subscribers=2500000,
             model_fee_6month=400000000, model_fee_1year=700000000,
             contact1="010-7777-8888"),
    ]
    ids = {}
    inserted = skipped = 0
    for r in records:
